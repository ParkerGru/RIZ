            ...
            <View style={ styles.container }>
                ...
                <View style={styles.logoBack}>
                    <ImageBackground style={styles.loginLogo} source={require('../../assets/images/logo_back.png')} resizeMode="cover"  >
                        <Image style={styles.logoStyle} resizeMode='contain' source={require('../../assets/images/signup_logo.png')} />
                    </ImageBackground>
                </View>
                <View style={ styles.loginBar }>
                    ...
                    <View style={{ flex: 1, justifyContent: 'space-evenly' }}>
                        ...
                        <Text style={styles.alreadyButtonText} onPress={() => navigation.navigate('LoginScreen')}>Already have an account? Login</Text>
                        {/* <View style={styles.buttonStyle}>
                            <TouchableOpacity
                                style={styles.createButton}
                                activeOpacity={0.6}
                                onPress={() => Alert.alert('Info', 'Clicked create account button') }
                            >
                            </TouchableOpacity>
                        </View> */}
                    </View>
